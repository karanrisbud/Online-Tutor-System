...
function Navbar() {
    ...
    return (  
        <nav className="navbar navbar-expand-lg navbar-dark bg-dark static-top">
            ...
            <div className="collapse navbar-collapse" data-toggle="colapse" id="navbarSupportedContent" data-target=".navbar collapse">
                <ul className="navbar-nav ms-auto">
                    ...
                    {!tutor && <li><a className="nav-link active" href="/appointments" aria-current="page">Appointments</a></li>}
                    {tutor && <li><a className="nav-link active" href="/tutor_appointments" aria-current="page">Appointments</a></li>}
